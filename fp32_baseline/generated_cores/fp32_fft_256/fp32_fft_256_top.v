// =============================================================================
// FP32 Baseline FFT TOP - 256-point PIPELINED CONFIGURATION
//
// Same interface shape as mixed_fft_256_top, with 64-bit complex FP32 load /
...
module fp32_fft_256_top (
    ...
    fp32_fft_256_core #(
        ...
        .ext_rd_addr  ({3'b000, unload_addr}),
    ...
    always @(posedge clk or negedge rst) begin
        if (!rst) begin
            ...
            if (start) begin
                ...
                bank_sel <= 1'b1;   // bank holding the result (log2 N = 8)
