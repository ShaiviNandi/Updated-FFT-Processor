// =============================================================================
// FP32 Baseline FFT Core - 16-point FULLY PIPELINED II=1 ARCHITECTURE
//
// IEEE 754 binary32 (E8M23) throughout.  Reference design for benchmarking
// against the NSGA-optimised mixed-precision FP4/FP8 core mixed_fft_16_core.
//
...
module fp32_fft_16_core #(
    ...
    // Single-precision baseline: 4 stages, all FP32.
    localparam TOTAL_STAGES = 4;
