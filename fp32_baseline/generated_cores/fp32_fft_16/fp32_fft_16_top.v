// =============================================================================
// FP32 Baseline FFT TOP - 16-point PIPELINED CONFIGURATION
//
// Same interface shape as mixed_fft_16_top, with 64-bit complex FP32 load /
...
module fp32_fft_16_top (
    ...
    fp32_fft_16_core #(
        ...
        .ext_rd_addr  ({7'b0000000, unload_addr}),
    ...
    always @(posedge clk or negedge rst) begin
        if (!rst) begin
            ...
            if (start) begin
                ...
                bank_sel <= 1'b1;   // bank holding the result (log2 N = 4)
