// =============================================================================
// FP32 Baseline FFT TOP - 128-point PIPELINED CONFIGURATION
//
// Same interface shape as mixed_fft_128_top, with 64-bit complex FP32 load /
...
module fp32_fft_128_top (
    ...
    fp32_fft_128_core #(
        ...
        .ext_rd_addr  ({4'b0000, unload_addr}),
    ...
    always @(posedge clk or negedge rst) begin
        if (!rst) begin
            ...
            if (start) begin
                ...
                bank_sel <= 1'b0;   // bank holding the result (log2 N = 7)
