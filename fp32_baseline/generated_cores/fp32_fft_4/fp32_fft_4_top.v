// =============================================================================
// FP32 Baseline FFT TOP - 4-point PIPELINED CONFIGURATION
//
// Same interface shape as mixed_fft_4_top, with 64-bit complex FP32 load /
...
module fp32_fft_4_top (
    ...
    fp32_fft_4_core #(
        ...
        .ext_rd_addr  ({9'b000000000, unload_addr}),
    ...
    always @(posedge clk or negedge rst) begin
        if (!rst) begin
            ...
            if (start) begin
                ...
                bank_sel <= 1'b1;   // bank holding the result (log2 N = 2)
