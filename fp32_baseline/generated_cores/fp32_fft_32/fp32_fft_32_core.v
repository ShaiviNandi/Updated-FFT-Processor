// =============================================================================
// FP32 Baseline FFT Core - 32-point FULLY PIPELINED II=1 ARCHITECTURE
//
...
module fp32_fft_32_core #(
    ...
    // Single-precision baseline: 5 stages, all FP32.
    localparam TOTAL_STAGES = 5;
