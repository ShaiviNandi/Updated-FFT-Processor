// =============================================================================
// FP32 Baseline FFT TOP - 1024-point PIPELINED CONFIGURATION
//
// Same interface shape as mixed_fft_1024_top, with 64-bit complex FP32 load /
    ...
    always @(posedge clk or negedge rst) begin
        if (!rst) begin
            ...
            if (start) begin
                ...
                bank_sel <= 1'b1;   // bank holding the result (log2 N = 10)
