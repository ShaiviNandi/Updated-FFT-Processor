// =============================================================================
// FP32 Baseline FFT TOP - 2-point PIPELINED CONFIGURATION
//
// Same interface shape as mixed_fft_2_top, with 64-bit complex FP32 load /
...
module fp32_fft_2_top (
    ...
    input  wire              load_en,
    input  wire [0:0]  load_addr,
    input  wire [63:0]       load_data,

    input  wire              unload_en,
    input  wire [0:0]  unload_addr,
    ...
    fp32_fft_2_core #(
        ...
        .ext_rd_addr  ({10'b0000000000, unload_addr}),
