...
set genomeRtd $env(RT_TMP)/31A82160.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {fft_512_sol24_gen1_core__GC0}]"
...
set genomeName [subst -nocommands -novariables {fft_512_sol24_gen1_core__GC0}]
