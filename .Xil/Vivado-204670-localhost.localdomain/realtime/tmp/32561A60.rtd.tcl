...
set genomeRtd $env(RT_TMP)/32561A60.rtd
set parallel_map_command "rt::do_reinfer_area_combined 0"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {fft_256_sol26_gen3_core__GC0}]"
...
set genomeName [subst -nocommands -novariables {fft_256_sol26_gen3_core__GC0}]
