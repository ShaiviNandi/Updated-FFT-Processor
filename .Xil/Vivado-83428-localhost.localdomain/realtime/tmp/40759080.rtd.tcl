...
set genomeRtd $env(RT_TMP)/40759080.rtd
set parallel_map_command "rt::do_reinfer_area_combined 0"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {muxpart__2059_mixed_dual_bank_memory_concurrent}]"
...
set genomeName [subst -nocommands -novariables {muxpart__2059_mixed_dual_bank_memory_concurrent}]
