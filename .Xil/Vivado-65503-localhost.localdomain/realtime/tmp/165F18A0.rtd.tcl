...
set genomeRtd $env(RT_TMP)/165F18A0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 0"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {fft_256_sol13_gen2_core__GC0}]"
...
set genomeName [subst -nocommands -novariables {fft_256_sol13_gen2_core__GC0}]
