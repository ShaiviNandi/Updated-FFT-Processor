...
set genomeRtd $env(RT_TMP)/36CFD440.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {mixed_dual_bank_memory_concurrent__GB17}]"
...
set genomeName [subst -nocommands -novariables {mixed_dual_bank_memory_concurrent__GB17}]
