...
set genomeRtd $env(RT_TMP)/39E569C0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 0"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {mixed_dual_bank_memory_concurrent__GB14}]"
...
set genomeName [subst -nocommands -novariables {mixed_dual_bank_memory_concurrent__GB14}]
