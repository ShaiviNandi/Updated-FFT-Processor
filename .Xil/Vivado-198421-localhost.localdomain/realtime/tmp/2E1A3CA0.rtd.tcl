...
set genomeRtd $env(RT_TMP)/2E1A3CA0.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {muxpart__4117_mixed_dual_bank_memory_concurrent}]"
...
set genomeName [subst -nocommands -novariables {muxpart__4117_mixed_dual_bank_memory_concurrent}]
