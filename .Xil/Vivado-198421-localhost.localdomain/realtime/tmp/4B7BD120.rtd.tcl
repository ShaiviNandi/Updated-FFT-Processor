...
set genomeRtd $env(RT_TMP)/4B7BD120.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {mixed_dual_bank_memory_concurrent__GB23}]"
...
set genomeName [subst -nocommands -novariables {mixed_dual_bank_memory_concurrent__GB23}]
