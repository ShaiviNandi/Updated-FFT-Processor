// =============================================================================
// Mixed-Precision FFT Core - 32-point FULLY PIPELINED II=1 ARCHITECTURE
// Active-low asynchronous reset (negedge rst).
// =============================================================================
`timescale 1ns/1ps

module pipelined_fft_32_sweep_5_core #(
    ...
    wire [ADDR_WIDTH-1:0] current_stage_mask    = ext_reading ? 11'd1 : ((11'd32 >> 1) >> current_stage_stable);
    wire [ADDR_WIDTH-1:0] current_stage_mask_wr = ext_wr_en   ? 11'd1 : ((11'd32 >> 1) >> current_stage_stable_delayed);
    ...
    always @(*) begin
        case (current_stage_stable_delayed)
            ...
            4'd4: begin bf_mult_prec = 1'b0; bf_add_prec = 1'b1; end
