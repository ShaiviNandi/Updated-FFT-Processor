// =============================================================================
// Mixed-Precision FFT Core - 256-point FULLY PIPELINED II=1 ARCHITECTURE
// Active-low asynchronous reset (negedge rst).
// =============================================================================
`timescale 1ns/1ps

module preflight_256_core #(
    ...
    always @(*) begin
        case (current_stage_stable_delayed)
            ...
            4'd4: begin bf_mult_prec = 1'b0; bf_add_prec = 1'b0; end
            4'd5: begin bf_mult_prec = 1'b0; bf_add_prec = 1'b0; end
            4'd6: begin bf_mult_prec = 1'b0; bf_add_prec = 1'b0; end
            4'd7: begin bf_mult_prec = 1'b0; bf_add_prec = 1'b0; end
    ...
    wire [15:0] X_bf, Y_bf;
    wire        bf_is_fp8;
    butterfly_wrapper_gated #(.PIPELINE_OPERANDS(0)) shared_bf (
        .clk          (clk),
        .A            (A_24_aligned),
        .B            (B_24_aligned),
        .W            (twiddle),
