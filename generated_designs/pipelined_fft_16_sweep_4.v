// =============================================================================
// Mixed-Precision FFT Core - 16-point FULLY PIPELINED II=1 ARCHITECTURE
// Active-low asynchronous reset (negedge rst).
// =============================================================================
`timescale 1ns/1ps

module pipelined_fft_16_sweep_4_core #(
    ...
    wire [ADDR_WIDTH-1:0] current_stage_mask    = ext_reading ? 11'd1 : ((11'd16 >> 1) >> current_stage_stable);
    wire [ADDR_WIDTH-1:0] current_stage_mask_wr = ext_wr_en   ? 11'd1 : ((11'd16 >> 1) >> current_stage_stable_delayed);
