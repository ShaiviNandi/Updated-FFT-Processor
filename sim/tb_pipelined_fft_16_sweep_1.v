`timescale 1ns/1ps
module tb_pipelined_fft_16_sweep_1;
    ...
    pipelined_fft_16_sweep_1_top dut (
    ...
    initial begin : STIM
        ...
        tv[174] = 16'h009e;
        tv[175] = 16'h1595;
        out_file = $fopen("/home/digital-1/SRIP2026/Updated-FFT-Processor/sim/pipelined_fft_16_sweep_1_output.txt", "w");
        ...
        $display("\n================================================================");
        $display("  Pipelined Run Report  --  pipelined_fft_16_sweep_1 (FFT-16)");
        $display("================================================================");
