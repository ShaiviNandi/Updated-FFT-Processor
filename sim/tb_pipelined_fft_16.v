...
module tb_pipelined_fft_16;
    ...
    initial begin : STIM
        ...
        tv[174] = 16'h009e;
        tv[175] = 16'h1595;
        out_file = $fopen("C:/Updated-FFT-Processor/sim/pipelined_fft_16_output.txt", "w");
        ...
        $display("\n================================================================");
        $display("  Pipelined Run Report  --  pipelined_fft_16 (FFT-16)");
        $display("================================================================");
