`timescale 1ns/1ps
module tb_pipelined_fft_32_sweep_5;
    ...
    pipelined_fft_32_sweep_5_top dut (
    ...
    initial begin : STIM
        ...
        tv[350] = 16'h009a;
        tv[351] = 16'h1595;
        out_file = $fopen("/home/digital-1/SRIP2026/Updated-FFT-Processor/sim/pipelined_fft_32_sweep_5_output.txt", "w");
        ...
        $display("\n================================================================");
        $display("  Pipelined Run Report  --  pipelined_fft_32_sweep_5 (FFT-32)");
        $display("================================================================");
