`timescale 1ns/1ps
module tb_pipelined_fft_8_sweep_6;
    ...
    pipelined_fft_8_sweep_6_top dut (
    ...
    initial begin : STIM
        ...
        tv[86] = 16'h00a7;
        tv[87] = 16'h1696;
        out_file = $fopen("/home/digital-1/SRIP2026/Updated-FFT-Processor/sim/pipelined_fft_8_sweep_6_output.txt", "w");
        ...
        $display("\n================================================================");
        $display("  Pipelined Run Report  --  pipelined_fft_8_sweep_6 (FFT-8)");
        $display("================================================================");
