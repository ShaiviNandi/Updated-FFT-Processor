// =============================================================================
// FP16 Baseline FFT Core - 4-point FULLY PIPELINED II=1 ARCHITECTURE
//
// IEEE 754 binary16 (E5M10) throughout.  Reference design for benchmarking
// against the NSGA-optimised mixed-precision FP4/FP8 core mixed_fft_4_core.
//
...
module fp16_fft_4_core #(
    ...
    // Single-precision baseline: 2 stages, all FP16.
    localparam TOTAL_STAGES = 2;
